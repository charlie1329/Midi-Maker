...
typedef std::vector<byte>::iterator vecItr;
...
VLQ uintToVLQ(unsigned int num) {
    ...
    //TODO: Change if endian-ness is wrong!!! also take a look if really inefficient or not
    return converted;
 ...
 * TODO: Check this!!! assuming system is big endian, i.e. msb is in lowest memory position
 */
